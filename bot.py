...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "→ Gemini har cut/scene ko identify karega\n"
        "→ bot source episode ko progressively verify karega\n"
        "→ exact scene clips + speed preserve karega\n"
        "→ sab scenes ko ek final video me merge karega\n"
